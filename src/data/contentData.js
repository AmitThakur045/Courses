      ...
      lesson: [
        {
          ...
          lessonDescription:
            "We will begin with the introduction to Data Science and cover all the fundamentals like Statistics, Probability, etc., which are key topics in Data Analytics courses.",
          topic: [
            {
            ...
            {
              topicName: "Introduction to Probability",
              topicDescription:
            ...
            {
              topicName: "Hypothesis Testing and Estimation",
              topicDescription:
        ...
        {
          lessonName: "Business Finance",
          lessonDescription:
            "We will cover all the fundamentals of how business finance works in a company used to run their business operations. Business Finance is one of the most important topics in Data Analytics courses.",
          topic: [
            {
              topicName: "Fundamentals of Finance",
              topicDescription:
            ...
            {
              topicName: "Working Capital Management",
              topicDescription:
        ...
        {
          lessonName: "Marketing and CRM",
          lessonDescription:
            "In this business analytics online course, we will cover all the fundamentals of how a business handles its marketing strategies and Customer Relationship Management (CRM).",
          topic: [
            {
              topicName: "Core Concepts of Marketing",
              topicDescription:
            ...
            {
              topicName: "Customer Life Time Value",
              topicDescription:
        ...
        },
        {
          ...
          lessonDescription:
            "Here, we will cover all the critical concepts you need to learn about Python programming for Data Science, such as NumPy, Pandas, Matplotlib, Seaborn, etc.",
          topic: [
            {
            ...
            {
              topicName: "Visualization using Python (Matplotlib & Seaborn)",
              topicDescription:
                "Matplotlib, another vastly implemented Python library, is a library to create statically animated, interactive visualizations. This module will give you an in-depth understanding of exploring data sets using Matplotlib. Seaborn is also one of the most vastly implemented Python libraries. It is a Matplotlib-based data visualization library in Python. In this module, you will gain an in-depth understanding of exploring data sets using Seaborn.",
            },
            {
              topicName: "Dealing with Data using Python",
              topicDescription:
